'''
This script can be used to make figure 2, assuming you made the required
...
# files output by lcc_variance_eps_effect
...
plt.plot([np.log(64), np.log(512)], [-2.5, -2.5 - np.log(512) + np.log(64)], '--')
...
plt.title(r"Impact of $m$ and $\varepsilon$ on the Variance (5D Log-Concave)",fontsize=15)
plt.tight_layout()
