'''
This script can be used to make figure 7, assuming you made the required
...
plt.title(r'Effect of $d$ (GMM, $\varepsilon=5.0$)',fontsize=15)
plt.tight_layout()
plt.show()
